...
resource "aws_eks_access_entry" "eks_access_entry" { # Crea una entrada de acceso a EKS
...
resource "aws_eks_access_policy_association" "eks_access_policy_association" { # Asocia una política de acceso a EKS
  cluster_name  = var.eks.cluster_name
